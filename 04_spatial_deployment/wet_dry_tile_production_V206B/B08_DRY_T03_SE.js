...
// ============================================================================
// A09 V206B — PRODUCTION BATCH B08
// Window: DRY_20191113_20191125
// Tile:   T03_SE
// Expected scene×tile exports from frozen V206A audit: 5
// ============================================================================
// IMPORTANT:
...
var PRODUCTION_BATCH = {
  ...
  tileId: 'T03_SE',
  tileRect: [105.166667, -4.8, 106.5, -3.15],
  expectedTaskCount: 5,
  tileBufferM: 12000
};
...
Export.table.toDrive({
  ...
  description: 'A09_V206B_B08_DRY_T03SE_BATCH_MANIFEST',
  folder: CONFIG.driveFolder,
  fileNamePrefix: 'A09_V206B_B08_DRY_T03SE_BATCH_MANIFEST',
  fileFormat: 'CSV'
});
