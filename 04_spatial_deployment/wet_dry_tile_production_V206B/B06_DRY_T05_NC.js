...
// ============================================================================
// A09 V206B — PRODUCTION BATCH B06
// Window: DRY_20191113_20191125
// Tile:   T05_NC
// Expected scene×tile exports from frozen V206A audit: 7
// ============================================================================
// IMPORTANT:
...
var PRODUCTION_BATCH = {
  batchOrder: 6,
  batchId: 'B06',
  windowId: 'DRY_20191113_20191125',
  windowCode: 'DRY',
  startWib: '2019-11-13',
  endExclusiveWib: '2019-11-25',
  startUtc: '2019-11-12T17:00:00',
  endExclusiveUtc: '2019-11-24T17:00:00',
  tileId: 'T05_NC',
  tileRect: [103.833333, -3.15, 105.166667, -1.5],
  expectedTaskCount: 7,
  tileBufferM: 12000
};
...
Export.table.toDrive({
  ...
  description: 'A09_V206B_B06_DRY_T05NC_BATCH_MANIFEST',
  folder: CONFIG.driveFolder,
  fileNamePrefix: 'A09_V206B_B06_DRY_T05NC_BATCH_MANIFEST',
  fileFormat: 'CSV'
});
