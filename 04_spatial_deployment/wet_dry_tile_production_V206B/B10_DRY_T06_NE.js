...
// ============================================================================
// A09 V206B — PRODUCTION BATCH B10
// Window: DRY_20191113_20191125
// Tile:   T06_NE
// Expected scene×tile exports from frozen V206A audit: 3
// ============================================================================
// IMPORTANT:
...
var PRODUCTION_BATCH = {
  ...
  tileId: 'T06_NE',
  tileRect: [105.166667, -3.15, 106.5, -1.5],
  expectedTaskCount: 3,
  tileBufferM: 12000
};
...
Export.table.toDrive({
  ...
  description: 'A09_V206B_B10_DRY_T06NE_BATCH_MANIFEST',
  folder: CONFIG.driveFolder,
  fileNamePrefix: 'A09_V206B_B10_DRY_T06NE_BATCH_MANIFEST',
  fileFormat: 'CSV'
});
