...
// ============================================================================
// A09 V206B — PRODUCTION BATCH B07
...
var PRODUCTION_BATCH = {
  ...
  tileId: 'T02_SC',
  tileRect: [103.833333, -4.8, 105.166667, -3.15],
  expectedTaskCount: 4,
  tileBufferM: 12000
};
...
Export.table.toDrive({
  ...
  description: 'A09_V206B_B07_DRY_T02SC_BATCH_MANIFEST',
  folder: CONFIG.driveFolder,
  fileNamePrefix: 'A09_V206B_B07_DRY_T02SC_BATCH_MANIFEST',
  fileFormat: 'CSV'
});
